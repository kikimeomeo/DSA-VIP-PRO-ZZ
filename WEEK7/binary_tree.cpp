...
int main()
{
    ...
    root->p_left = createNode(30);
    root->p_right = createNode(70);
    root->p_left->p_left = createNode(20);
    root->p_left->p_right = createNode(40);
    root->p_right->p_left = createNode(60);
    root->p_right->p_right = createNode(90);
    root->p_left->p_left->p_left = createNode(10);
    root->p_left->p_right->p_right = createNode(45);
    ...
    cout << "Level of node 45: " << Level(root, root->p_left->p_right->p_right) << endl;
    cout << "Height of node 30: " << heightNode(root, 30) << endl;
